...
{
    public partial class AirportSuggestionBox : UserControl
    {
        private IValueConverter m_itemConverter;
        ...
        public AirportSuggestionBox()
        {
            m_itemConverter = new AirportConverter();

            Resources.Add("ItemConverter", m_itemConverter);
        ...
        private void SuggestionBoxSelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            if (SuggestionListBox.SelectedItem == null)
                ...
                EntryBox.Text = (string)m_itemConverter.Convert(SuggestionListBox.SelectedItem, typeof(string), null, CultureInfo.CurrentCulture);
        ...
        public static readonly DependencyProperty EntryTextProperty =
            DependencyProperty.Register(nameof(EntryText), typeof(string), typeof(AirportSuggestionBox), new PropertyMetadata(String.Empty));

        public static readonly DependencyProperty ItemsSourceProperty =
            DependencyProperty.Register(nameof(ItemsSource), typeof(IEnumerable), typeof(AirportSuggestionBox), new PropertyMetadata(defaultValue: null));

        public static readonly DependencyProperty SelectedItemProperty =
            DependencyProperty.Register(nameof(SelectedItem), typeof(object), typeof(AirportSuggestionBox), new PropertyMetadata(defaultValue: null));
    }
}
